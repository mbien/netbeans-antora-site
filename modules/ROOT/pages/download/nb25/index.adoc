...
Apache NetBeans {netbeans-version} was released on February 10, 2025.
// TODO update date                                ^^^^
...
Apache NetBeans {netbeans-version} supports running on JDK 24, 21, or 17. For the best experience we recommend using link:https://javaalmanac.io/jdk/24/[JDK 24].
